...
CPU_IOFlushDCache((long)mycp0ins&0x1f,32,1);
CPU_FlushICache((long)mycp0ins&0x1f,32);

 asm(".global mycp0ins;mycp0ins:csrrd $r2,0x10;move %0,$r2" :"=r"(data8)::"$r2");
...
#endif
CPU_IOFlushDCache((long)mycp0ins1&0x1f,32,1);
CPU_FlushICache((long)mycp0ins1&0x1f,32);

 asm(".global mycp0ins1;move $r2,%0;mycp0ins1:csrwr $r2,0x10;"::"r"(*(long *)mydata->data8):"$r2");
