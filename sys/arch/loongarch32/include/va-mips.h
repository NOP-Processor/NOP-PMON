...
#define __GNUC_VA_LIST
#if 0 && ! defined (__loongarch_soft_float) && ! defined (__loongarch_single_float)
...
#define va_start(__AP, __LASTARG) __builtin_va_start(__AP, __LASTARG)
  //(__AP = (__gnuc_va_list) __builtin_next_arg (__LASTARG) - 28)
#endif /* ! (defined (__loongarch_eabi) && ! defined (__loongarch_soft_float) && ! defined (__loongarch_single_float)) */
#else /* ! _STDARG_H */
...
#elsif defined(_LOONGARCH_SIM) && (_MIPS_SIM == _MIPS_SIM_ABI64 || _MIPS_SIM == _MIPS_SIM_NABI32)
#define va_start(__AP)							\
  (__AP = (__gnuc_va_list) __builtin_next_arg ()			\
